...
**Install** — download pre-built binaries for your OS from [GitHub Releases](https://github.com/AntonyCyriac/logscope/releases) (`v2.0.0`+ includes `logscope-desktop` on Linux), or build from source below.
