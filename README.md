...
**Status:** [`v1.5.0`](CHANGELOG.md) — M12 Dynamic Plugins shipped. M0–M12 complete. See [Roadmap](docs/ROADMAP.md) and [Changelog](CHANGELOG.md).
...
**Install** — download a pre-built binary for your OS from [GitHub Releases](https://github.com/AntonyCyriac/logscope/releases) (`v1.5.0`+), or build from source below.
