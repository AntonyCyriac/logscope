...
LogScope **v2.11.0** ships **Stories 1–6**, **P1 Crash Timeline**, **P1.1** TID pstack dialects, **P2** desktop Timeline/Crash parity, and **v2.10.1** storage hotfixes. See [Next Value-Add Backlog](planning/NEXT-VALUE-ADD.md).
