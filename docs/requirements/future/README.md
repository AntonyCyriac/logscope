...
Do not treat PRD-001 as an implementation checklist for the next milestone. Near-term public work is defined in [ROADMAP.md](../../ROADMAP.md) (M12 Dynamic Plugins, then M13 AI Assistant).
...
| Document | Use when |
|----------|----------|
| [ROADMAP.md](../../ROADMAP.md) | Near-term milestones (M12, M13) |
