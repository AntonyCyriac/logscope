...
**Current release:** [`v2.11.0`](../../CHANGELOG.md) — Stories 1–6 + P1 + P1.1 + P2 desktop parity (CLI, desktop, web). **Next:** P2.1 — desktop Evidence/Suggestions. See [CHANGELOG](../../CHANGELOG.md) for release history.
