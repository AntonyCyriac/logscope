...
**Current release:** `v2.13.1` (shipped). **Next:** **#144-B** `register_crash_analyzer` when justified · **P3** reactive charter · post–v2.13.0 evidence review G0. H0 Wave 1–2 complete.
...
| H0 | Quality & Integrity hardening | **Shipped** — `v2.13.0` Wave 1 ([#188](https://github.com/AntonyCyriac/logscope/issues/188) [#189](https://github.com/AntonyCyriac/logscope/issues/189) [#195](https://github.com/AntonyCyriac/logscope/issues/195) [#203](https://github.com/AntonyCyriac/logscope/issues/203)) · `v2.13.1` Wave 2 ([#198](https://github.com/AntonyCyriac/logscope/issues/198) [#197](https://github.com/AntonyCyriac/logscope/issues/197)) |
