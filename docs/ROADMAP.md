...
**Current release:** [`v2.10.0`](CHANGELOG.md) — P1.1 pstack dialects. Stories 1–6 + P1 + P1.1 shipped. **Next:** P2 desktop Timeline/Crash parity — see [Next Value-Add Backlog](planning/NEXT-VALUE-ADD.md).
