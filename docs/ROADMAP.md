...
**Current release:** [`v2.13.3`](CHANGELOG.md) — Run Comparison (Wave 4). Stories 1–6 + P1 + P1.1 + P2 + P2.1 + H0 Wave 1–4 shipped. **Next:** **#144-B** when justified · deferred hardening backlog — see [Next Value-Add Backlog](planning/NEXT-VALUE-ADD.md).
