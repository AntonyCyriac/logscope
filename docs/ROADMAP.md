...
**Current release:** [`v2.13.0`](CHANGELOG.md) — Quality & Integrity hardening (Wave 1). Stories 1–6 + P1 + P1.1 + P2 + P2.1 shipped. **Next:** **#144-B** when justified · deferred hardening backlog — see [Next Value-Add Backlog](planning/NEXT-VALUE-ADD.md).
