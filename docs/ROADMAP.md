...
| **M15 – Web Platform** | ⏳ Planned | Dashboard, REST API, shared investigations. [ADR-009](architecture/decisions/ADR-009-Web-Platform-REST.md) accepted (M15.0 gate). Target: `v2.1.0`. |
